...
CREATE DATABASE Vtas_TECH_STORE;
USE Vtas_TECH_STORE;
...
Nombre varchar(100) not null, email varchar(100) unique, Ciudad varchar(50),
...
id_clientes int foreign key(id_clientes) references clientes(id_cliente),
...
VALUES ('Computación', 'Laptops, PCs y monitores'),
 ...
 INSERT INTO productos(nombre_producto, id_categoria, precio_unitario, stock, activa)
